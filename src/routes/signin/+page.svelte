...
<!--
<h1>Sign In</h1>
<p>Sign in functionality will be added here.</p>
-->
...
<style>
	...
	.signin-container {
		...
		text-align: center;
		padding: 1rem;
		background: linear-gradient(135deg, #121212, #1db95420); /* subtle Spotify-like background */
	}
