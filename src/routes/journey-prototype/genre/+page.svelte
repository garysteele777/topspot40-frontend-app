<script lang="ts">
    ...
    const text = {
        en: {
            title: 'Choose Your Musical Genre',
            instruction: 'Select a genre to continue your journey.',
            continue: 'Continue',
            back: 'Back',
            home: 'Home',
            contact: 'Contact Us',
        ...
        es: {
            ...
            instruction: 'Selecciona un género para continuar tu viaje.',
            continue: 'Continuar',
            back: 'Atrás',
            home: 'Inicio',
            contact: 'Contáctanos',
        ...
        ptbr: {
            title: 'Escolha seu gênero musical',
            instruction: 'Selecione um gênero para continuar sua jornada.',
            continue: 'Continuar',
            back: 'Voltar',
            home: 'Início',
    ...
    onMount(() => {
        ...
        selectedDecade =
            new URLSearchParams(window.location.search).get('decade') ||
            localStorage.getItem('topspot_journey_decade') ||
            '';
    });
</script>

<svelte:head>
    <title>Choose Your Musical Genre</title>
</svelte:head>
...
<img
            class="journey-art"
            src="/images/journey/08-ai-genre-road.png"
            alt="Eight musical roads leading to TopSpot40 genres"
        />
...
{#each genres as genre}
            <button
                class="genre-button genre-{genre}"
...
<style>
    ...
    .hotspot-layer .genre-button {
        height: 14.8%;
        border-radius: 5px;
    }

    .hotspot-layer .genre-country,
    .hotspot-layer .genre-pop,
    .hotspot-layer .genre-rock,
    .hotspot-layer .genre-rnb_soul {
        left: 4.85%;
        width: 16.65%;
    }

    .hotspot-layer .genre-latin_global,
    .hotspot-layer .genre-blues_jazz,
    .hotspot-layer .genre-folk_acoustic,
    .hotspot-layer .genre-tv_themes {
        left: 79.35%;
        width: 16.2%;
    }
