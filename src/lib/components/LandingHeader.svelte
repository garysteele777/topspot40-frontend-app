...
{#if showContactUsModal}
    ...
    <div class="modal-backdrop" on:click={closeContactUsModal}>
        ...
        <div class="modal-content" on:click|stopPropagation>
            <button  type="button" class="close-btn" on:click={closeContactUsModal} aria-label="Close contact form"
            >&times;
            </button
            >
            <h2>Contact Us</h2>
            ...
            {#if showThankYou}
                ...
                <button  type="button" on:click={closeContactUsModal} class="ok-btn">Close</button>
            {:else if showFeedbackForm}
                ...
                >
            {:else}
                <button  type="button" on:click={openFeedbackForm} class="feedback-btn">Send Feedback</button>
            {/if}
        </div>
    </div>
{/if}
